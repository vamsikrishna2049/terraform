...
Key components:
----------------
Route 53: Manages the domain name resolution and directs traffic to the application.
Amazon CloudFront: Distributes static content from edge locations around the world for improved performance and reduced latency.
...
Amazon S3: Stores static content and logs.
